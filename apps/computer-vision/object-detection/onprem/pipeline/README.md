...
Train an object-detection darknet model, convert the darknet model/weights to tflite and serve using Kubeflow pipeline; and perform prediction for client request through Jupyter-notebook.
